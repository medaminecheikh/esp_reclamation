...
function IssueProject({myProjects}) {
    ...
    <Grid item >
        ...
        <Typography  variant="h5" color="textSecondary" style={{display:'flex', justifyContent:'space-between'
            ...
            <InfoIcon fontSize="large" color="primary" /> <p style={{ marginLeft: '10px' }}>  Aucun ticket trouvé sur nos plateformes</p>
        </Typography>
...
<Divider variant="inset" component="li" />
    <ListItem>
         <ListItemAvatar>
            <Avatar>
             <SchoolRoundedIcon />
                ...
                <Grid item>
                    ...
                    <ListItemText primary={project && project.name ? project.name : "Unknown" } secondary="Jan 9, 2014" />
                </Grid>
                <Grid item>
            ...
            height: 24, 
            fontSize: '0.875rem'}} >
                        <Typography variant="h6" color="common.white"> {project && project.repeated  } </Typography>
                    </Avatar>
                </Grid>
            </Grid>
    </ListItem>
