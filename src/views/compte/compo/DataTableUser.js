        ...
        <div style={{flexGrow: 1, alignItems: 'center'}}>
            <TableContainer component={Paper} style={{maxHeight: 400}}>
                <Table stickyHeader size="small" aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell align="center" colSpan={3}><TextField id="standard-basic" label="Search by Email"
                                                                             variant="standard"/></TableCell>
                            <TableCell align="center" colSpan={3}> <TextField id="Role-basic" label="Search by Role"
                                                                              variant="standard"/></TableCell>
                        </TableRow>
                        <TableRow>
                    ...
                    <TableBody style={{overflow: 'auto'}}>
                        {Users?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => (
                            ...
                            >
                                ...
                                <TableCell align="center">{row.role.name === 'admin' ?
                                    <Chip label="Admin" color="secondary"
                                          sx={{bgcolor: '#cf0a80', minWidth: '80px', fontSize: '14px', paddingX: 1}}
                                          size="small"/> :
                                ...
                                <TableCell align="center">{row.enabled ?
                                    ...
                                    <Chip label="Désactiver" sx={stylechip} size="small"
                                          deleteIcon={<DoneIcon/>}/>}</TableCell>
