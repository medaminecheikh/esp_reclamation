            ...
            <Grid container justifyContent="center">
                <Grid item xs={12}>
                    <Stack spacing={4}>
                        ...
                        <Box sx={{display: 'flex', height: 180}}> {/* Adjust height as needed */}
                            <TabContext value={value}
                                ...
                                <TabList
                                    ...
                                    sx={{borderRight: 1, borderColor: 'divider'}}
                                >
                                    <Tab icon={<PersonPinCircleOutlined/>} sx={{paddingRight: 6}} iconPosition="start"
                                         label="Detail Compte" value="1"/>
                                    <Tab icon={<Key/>} sx={{paddingRight: 6}} iconPosition="start" label="Password"
                                         value="2"/>
                                ...
                                <TabPanel value="1">
                                    ...
                                    <Stack direction="row" width={'100%'} style={{marginLeft: '50px'}}
                                           justifyContent={'space-evenly'} display={'flex'} spacing={3}>
                                        <TextField
                                            label="Email"
                                            id="username"
                                            variant="filled"
                                ...
                                <TabPanel value="2" sx={{
                                    ...
                                    <Grid item xs={12}
                                          sx={{justifyContent: 'space-around', display: 'flex', maxWidth: '60%'}}>
                                        <TextField
                                            label="New Password"
                                            id="password"
                                            variant="filled"
                        ...
                        <Stack direction="row" style={{marginTop: '60px', width: '100%'}} justifyContent="flex-end"
                               spacing={2}>
                            <Grid item xs={4}>
                                <AnimateButton>
                                    <Button
